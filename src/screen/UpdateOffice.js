...
renderItem = ({ item ,index}) => {
  //const {ofi}=item.ONN;
  this.state.officename=item.ON;
  //const state=this.state
  this.state.enginnername=item.EN;
  this.state.phonenumber=item.PN;
  this.state.facebook=item.FA;
  this.state.address=item.AD;
  this.state.telfax=item.TE;
  this.state.email=item.EM;
   
  this.state.ON=this.state.officename;
  this.state.EN=this.state.enginnername;
  this.state.PN=this.state.phonenumber;
  this.state.FA=this.state.facebook;
